...
errHand:
        ...
        End If
    End Sub
    Public Sub GenRPT(ByRef rptRS As ADODB.Recordset, ByRef rptDT As DataTable, ByRef RepViewer As CrystalDecisions.Windows.Forms.CrystalReportViewer, ByRef CrysRep As CrystalDecisions.CrystalReports.Engine.ReportClass, ByVal TBL As Integer, ByVal FString As String)
        Dim colCTR, wds, wdsctr As Integer
