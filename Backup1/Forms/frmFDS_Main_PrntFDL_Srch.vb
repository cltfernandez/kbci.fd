...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmFDS_Main_PrntFDL_Srch))
...
#End Region
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        End If
        FillLV(ListView1, Label5, rsMEM_SRC, "0:100:222:241:38:0")
        If rsMEM_SRC.RecordCount > 0 Then ListView1.Focus()
    ...
    Private Sub frmFDS_Main_PrntFDL_Srch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        rsMEM_SRC.Open("SELECT KBCI_ID,KBCI_NO, LNAME,FNAME,MI,FEBTC_SA FROM MEMBERS", cn, CursorTypeEnum.adOpenKeyset, LockTypeEnum.adLockReadOnly)
    End Sub
