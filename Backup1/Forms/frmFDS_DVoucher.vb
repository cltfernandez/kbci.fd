...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmFDS_DVoucher))
        ...
        Me.Button1.Location = New System.Drawing.Point(440, 34)
        ...
        Me.ListView1.Location = New System.Drawing.Point(16, 80)
        Me.ListView1.MultiSelect = False
        Me.ListView1.Name = "ListView1"
        Me.ListView1.Size = New System.Drawing.Size(456, 112)
        ...
        Me.TextBox5.Location = New System.Drawing.Point(320, 32)
        ...
        Me.TextBox6.Location = New System.Drawing.Point(16, 32)
        ...
        Me.Button2.Location = New System.Drawing.Point(456, 34)
        ...
        Me.TextBox3.Size = New System.Drawing.Size(112, 16)
        ...
        Me.Label7.Location = New System.Drawing.Point(304, 72)
        ...
        Me.Button4.Location = New System.Drawing.Point(384, 328)
        ...
        'Label9
        '
        Me.Label9.BackColor = System.Drawing.Color.FromArgb(CType(247, Byte), CType(254, Byte), CType(203, Byte))
        ...
        Me.Label9.Location = New System.Drawing.Point(64, 18)
...
#End Region
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If Decimal.Round(Label8.Text, 2) = 0 And ListView1.Items.Count > 2 Then
            SVG = SVG - CDT
            With ListView1
                QRY = "UPDATE DIVREFPH SET [CVNO]='" & CVNo() & "',[SAVINGS]=" & SVG & ",[TDEBDESC1]='" & .Items(0).Text & "',[TDEBAMT1]=" & Decimal.Round(.Items(0).SubItems(1).Text, 2) & "," & _
                            "[TDEBDESC2]='" & .Items(1).Text & "',[TDEBAMT2]=" & Decimal.Round(.Items(1).SubItems(1).Text, 2) & ",[TDEBDESC3]='" & .Items(2).Text & "',[TDEBAMT3]=" & Decimal.Round(.Items(2).SubItems(1).Text, 2) & ", " & _
                            "[USER]='" & CLUSER & "' WHERE [YEAR]='" & SELYR & "' AND [QUARTER]='" & SELQTR & "'"
                cn.Execute(QRY)
                ...
                cn.Execute(QRY)
                ListView1.Clear()
                msg = MsgBox("Successfully processed! Would you like to print the Dividend Voucher? ", MsgBoxStyle.Information.YesNo, "DIVIDEND VOUCHER")
                If msg = vbYes Then
                    SW = True
                End If
                Me.Close()
    ...
    Private Sub frmFDS_DVoucher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Label8.Text = FormatNumber(Decimal.Round(TextBox3.Text, 2) + Decimal.Round(Label6.Text, 2), 2)
        rsDV.Close()
    End Sub
    Function CVNo() As String
        Dim TMPCVNo As Integer = Val(rsCTL.Fields("VOUCHER").Value)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If TextBox6.Text <> "" And TextBox5.Text <> "" And Decimal.Round(TextBox5.Text, 2) > 0 Then
            If ListView1.Items.Count < 3 Then
                lv = ListView1.Items.Add(TextBox6.Text.ToUpper)
                lv.SubItems.Add(TextBox5.Text)
                Label8.Text = FormatNumber(Decimal.Round(Label8.Text, 2) - Decimal.Round(TextBox5.Text, 2), 2)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If ListView1.SelectedItems.Count > 0 Then
            Label8.Text = FormatNumber(Decimal.Round(Label8.Text, 2) + Decimal.Round(ListView1.Items(ListView1.SelectedIndices(0)).SubItems(1).Text, 2), 2)
