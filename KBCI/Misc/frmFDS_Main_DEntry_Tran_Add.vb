...
#End Region
    ...
    Private Sub TRANSACT()
        ...
        TextBox2.Text = sysdate.ToString("yyyyMMdd") & sqNum.ToString("D2")
        rsFD_Mem.Filter = adFilterNone
    ...
    Private Sub TextBox5_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBox5.LostFocus
        If TextBox5.Text <> "" Then TextBox5.Text = FormatNumber(Val(TextBox5.Text), 2)
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        WLOG("INSERT INTO FD([KBCI_NO],[TRAN_CODE],[DATE],[REF],[AMOUNT],[BALANCE],[RMK],[ADD_DATE],[USER] ,[LPOSTED],[DRCR],[BANK_CODE],[CHECKNO],[TPOSTED],[TREVERSED])" & _
                         "VALUES('" & rsMEMBERS_L.Fields("KBCI_NO").Value & "','" & trOPT & "','" & TextBox1.Text & "','" & TextBox2.Text & "'," & Decimal.Round(TextBox5.Text, 2) & "," & BALANCE & ",'" & TextBox6.Text & "','" & TextBox1.Text & "','" & CLUSER & "',0,'" & trTYP & "','" & TextBox7.Text & "','" & TextBox8.Text & "',0,0)", App_Path() & "INSERT.log")
    ...
    Private Sub frmFDS_Main_DEntry_Tran_Add_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
