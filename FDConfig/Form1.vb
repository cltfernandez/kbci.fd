    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        With OpenFileDialog1
            ...
            If .ShowDialog() = DialogResult.OK Then
                If File.Exists(App_Path() & System.IO.Path.GetFileName(Application.ExecutablePath) & ".config") Then
                    File.Delete(App_Path() & System.IO.Path.GetFileName(Application.ExecutablePath) & ".config")
                End If
