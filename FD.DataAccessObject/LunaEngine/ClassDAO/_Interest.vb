...
Public MustInherit Class _Interest
	Inherits LUNA.LunaBaseClassEntity
    Implements _IInterest
...
Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IInterest.FillFromDataRecord
     INTEREST_ID = myRecord("INTEREST_ID")
...
Private Property Manager As LUNA.ILunaBaseClassDAO(Of Interest)
    Get
        If _Mgr Is Nothing Then
            Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
            If _MgrType Is Nothing Then _MgrType = GetType(InterestDAO)
            _Mgr = Activator.CreateInstance(_MgrType)
        End If
        Return _Mgr
    End Get
    Set(value As LUNA.ILunaBaseClassDAO(Of Interest))
        _Mgr = value
    End Set
End Property
...
Protected _INTEREST_ID as Int64  = Nothing 
Public Overridable Property INTEREST_ID() as Int64  Implements _IInterest.INTEREST_ID
    Get
	    Return _INTEREST_ID
    End Get
    Set (byval value as Int64)
	    If _INTEREST_ID <> value Then
	        IsChanged = True
	        _INTEREST_ID= value
	    End If
    End Set
...
Public Overridable Property ACCTNO() as string  Implements _IInterest.ACCTNO
    Get
	    Return _ACCTNO
    End Get
...
Public Overridable Property APLINT() as single  Implements _IInterest.APLINT
    Get
	    Return _APLINT
    End Get
...
Public Overridable Property EDLINT() as single  Implements _IInterest.EDLINT
    Get
	    Return _EDLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property EMLINT() as single  Implements _IInterest.EMLINT
    Get
	    Return _EMLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property RGLINT() as single  Implements _IInterest.RGLINT
    Get
	    Return _RGLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property RSLINT() as single  Implements _IInterest.RSLINT
    Get
	    Return _RSLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property SPLINT() as single  Implements _IInterest.SPLINT
    Get
	    Return _SPLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property LHLINT() as single  Implements _IInterest.LHLINT
    Get
	    Return _LHLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property STLINT() as single  Implements _IInterest.STLINT
    Get
	    Return _STLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property CMLINT() as single  Implements _IInterest.CMLINT
    Get
	    Return _CMLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property FALINT() as single  Implements _IInterest.FALINT
    Get
	    Return _FALINT
    End Get
    Set (byval value as single)
...
Public Overridable Property MPLINT() as single  Implements _IInterest.MPLINT
    Get
	    Return _MPLINT
    End Get
    Set (byval value as single)
...
Public Overridable Property XMAINT() as single  Implements _IInterest.XMAINT
    Get
	    Return _XMAINT
    End Get
    Set (byval value as single)
...
Public Overridable Property REC_STAT() as Boolean  Implements _IInterest.REC_STAT
    Get
	    Return _REC_STAT
    End Get
...
#Region "Method"
''' <summary>
'''This method read an Interest from DB.
''' </summary>
''' <returns>
...
Public Overridable Function Read(Id As Integer) As Integer
    ...
    Try
	    Using Manager
	        Dim int As Interest = Manager.Read(Id)
                    _INTEREST_ID = int.INTEREST_ID
                    _ACCTNO = int.ACCTNO
                    _APLINT = int.APLINT
                    _EDLINT = int.EDLINT
                    _EMLINT = int.EMLINT
...
''' <summary>
'''This method save an Interest on DB.
''' </summary>
''' <returns>
