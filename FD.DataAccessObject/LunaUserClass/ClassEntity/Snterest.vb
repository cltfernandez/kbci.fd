...
''' <summary>
'''Entity Class for table Snterest
''' </summary>
''' <remarks>
'''Write your custom method and property here
''' </remarks>

Public Class Snterest
	Inherits _Snterest
    Implements ISnterest
...
Public Overrides Property SNTEREST() as Int64
    Get
	    Return MyBase.SNTEREST
    End Get
    Set (byval value as Int64)
        MyBase.SNTEREST= value
    End Set
End property 
...
Public Overrides Function IsValid() As Boolean Implements ISnterest.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements ISnterest.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements ISnterest.Save
