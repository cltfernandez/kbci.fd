...
''' </remarks>
Public Class SnterestDAO
    Inherits _SnterestDAO

    Private Const _Table As String = "SNTEREST"
    ...
    Public Sub DeleteAll()
        Using myCommand As DbCommand = _Cn.CreateCommand
            myCommand.CommandText = "TRUNCATE TABLE SNTEREST"
